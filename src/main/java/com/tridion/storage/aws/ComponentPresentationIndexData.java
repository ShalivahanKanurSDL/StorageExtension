...
/**
 * ComponentPresentationIndexData.--> Which is used to get the Pages from JPAComponentPresentationPageDAO
 * 
 * POJO which holds all data necessary for an indexing action
 * 
 */
public class ComponentPresentationIndexData extends BaseIndexData
{
	private String _fileName;
	private String _fileSize;
	private String _fileType;
	private ComponentPresentation _content;
	private String _url;

	private ConcurrentHashMap<String, ArrayList<Object>> _indexFields = new ConcurrentHashMap<String, ArrayList<Object>>();

	public ComponentPresentationIndexData(FactoryAction action, IndexType itemType, String publicationId, String storageId, String searchDataXml)
	{
	 ...
	 * @return the content
	 */
	public ComponentPresentation getContent()
	{
		return _content;
	}
	 ...
	 */
	public void setContent(ComponentPresentation _content)
	{
	...
	public String toString()
	{
		...
		r.append(this._url);
		r.append(",{");
		for (Map.Entry<String, ArrayList<Object>> entry : this._indexFields.entrySet())
		{
